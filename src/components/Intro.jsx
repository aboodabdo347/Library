        ...
        <div className="row">
          <div className="col">
            ...
            <div className="mt-5 d-flex">
              <a href="/discoverbooks">
                <button className="btn btn-outline-secondary">
                  Start Discovering <ArrowOutwardIcon />
                </button>
              </a>
              <a href="/login">
          ...
          <div className="col d-flex flex-column">
            ...
            <div className="d-flex justify-content-between">
              <div className="text-start mt-3 intro-rating-bg">
                ...
                <p className="intro-rate-solgan">
                  He calls them atomic habits. In this ground-breaking book,
                  Clears reveals exactly how these minuscule changes can grow
                  into such life-altering outcomes.
                </p>
              </div>
            </div>
          </div>
